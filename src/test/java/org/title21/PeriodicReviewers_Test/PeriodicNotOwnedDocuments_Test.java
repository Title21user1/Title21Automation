...
public class PeriodicNotOwnedDocuments_Test extends BaseClass{
	...
	public void DocumentRoutes() throws Exception
	{
		...
		//=======================================================Prerequisites==========================================================================
		 ...
		 sleep(2);
		 periodicReviews.approvalFilter_TextBox().sendKeys(documentNo1);
		 sleep(2);
		...
		// documentNo3 = "ANT-FORM.759";
		 ...
		 sleep(2);
		 periodicReviews.filterText().sendKeys("secret");
		 periodicReviews.goButton().click();
		 sleep(2);
		 clickOnEditButton("secret");
		 sleep(2);
		...
		// periodicReviews.auditLogConfirm_Button().click();
		 ...
		 periodicReviews.wizardReview_Tab().click();
		 sleep(2);
		 periodicReviews.approvalFilter_TextBox().sendKeys(documentNo2);
		 sleep(2);
		 periodicReviews.approvalFilterGo_Button().click();
		 sleep(2);	
		...
		/* for(int i=1; i<=50; i++)
		 ...
		 if(verifyDocForReview(documentNo2))
		 {
	...
	private String createNewDocWithPeriodicReviewer()
	{
		...
		periodicReviews.getDocumentTitle().sendKeys("Test"+documentNo); 
		sleep(2);
		periodicReviews.getDocChangeSummary().sendKeys("Test Summary"+documentNo);
		...
		if(periodicReviews.getdocumentcreationverify().isDisplayed()) 
		{
			...
			{ 
				periodicReviews.editPeriodicReviewersLocationDropDown().selectByVisibleText("All"); 
				sleep(2);
