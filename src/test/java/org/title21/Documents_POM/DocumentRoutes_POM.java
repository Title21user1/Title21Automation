...
public class DocumentRoutes_POM extends CreateDocument_POM {
	...
	@FindBy(xpath="//button[@class='t21-ajax-submit-button form-control form-inline btn t21-btn-default']")
	WebElement go;
	...
	public void searchDoc(String docName)
	{
		searchText().sendKeys(docName);
		BaseClass.sleep(2);
		goButton().click();
		BaseClass.sleep(2);
	}
